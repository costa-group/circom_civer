...
This fork includes the verification tool CIVER (see more information in [CIVER tool](/mkdocs/docs/getting-started/civer.md)). 
...
You can find more information about the use of CIVER in [CIVER tool](/mkdocs/docs/getting-started/civer.md).
